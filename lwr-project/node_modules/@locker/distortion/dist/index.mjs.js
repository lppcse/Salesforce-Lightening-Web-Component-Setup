...
class VirtualRegistry$LWS {
  ...
  applyGet(cer$LWS, args$LWS) {
    ...
    return definition$LWS && definition$LWS.LocalCtor || ReflectApply$LWS(CustomElementRegistryProtoGet$LWS, cer$LWS, [tagName$LWS]);
  }
  ...
  setDefinition(instance$LWS, pivotDefinition$LWS) {
    ReflectSetPrototypeOf$LWS(instance$LWS, pivotDefinition$LWS.LocalCtor.prototype);
...
function createDefinitionRecord$LWS(LocalCtor$LWS) {
  ...
  const observedAttributes$LWS = toSafeSet$LWS(new SetCtor$LWS(LocalCtor$LWS.observedAttributes || []));
  return {
    adoptedCallback: adoptedCallback$LWS,
    attributeChangedCallback: attributeChangedCallback$LWS,
    connectedCallback: connectedCallback$LWS,
  ...
  return _a$LWS = class PivotCtor$LWS extends originalHTMLElementCtor$LWS {
    ...
    attributeChangedCallback(name$LWS, oldValue$LWS, newValue$LWS) {
      ...
      if (typeof attributeChangedCallback$LWS === 'function' && (originalDefinition$LWS === definition$LWS || observedAttributes$LWS != null && observedAttributes$LWS.has(name$LWS))) {
        ReflectApply$LWS(attributeChangedCallback$LWS, this, [name$LWS, oldValue$LWS, newValue$LWS]);
      }
    }
...
function getObservedAttributesList$LWS(baseDefinition$LWS, sourceDefinition$LWS) {
  ...
  return toSafeSet$LWS(new SetCtor$LWS([...sourceDefinition$LWS.observedAttributes].filter(
    ...
    if (attributePropertyName$LWS in instance$LWS) {
      const descriptor$LWS = {
        ...
        set(value$LWS) {
          ...
          const oldValue$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, this, [originalAttributeName$LWS]);
          ...
          const newValue$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, this, [originalAttributeName$LWS]);
          if (oldValue$LWS !== newValue$LWS) {
            ReflectApply$LWS(attributeChangedCallback$LWS, this, [originalAttributeName$LWS, oldValue$LWS, newValue$LWS]);
          }
        }
      };
      ReflectDefineProperty$LWS(instance$LWS, attributePropertyName$LWS, descriptor$LWS);
    }
  });
}
...
function triggerAttributeChangedCallbackDuringUpgrade$LWS(instance$LWS, originalDefinition$LWS) {
  ...
  if (attributeChangedCallback$LWS) {
    ...
    observedAttributes$LWS.forEach(name$LWS => {
      if (ReflectApply$LWS(ElementProtoHasAttribute$LWS, instance$LWS, [name$LWS])) {
        const newValue$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, instance$LWS, [name$LWS]);
        ReflectApply$LWS(attributeChangedCallback$LWS, instance$LWS, [name$LWS, null, newValue$LWS]);
      }
    });
  }
}
...
function unpatchCustomElementRegistry$LWS(globalObject$LWS) {
  ...
  CustomElementRegistryProto$LWS.get = getUnmaskedFunction$LWS(CustomElementRegistryProto$LWS.get);
  CustomElementRegistryProto$LWS.define = getUnmaskedFunction$LWS(CustomElementRegistryProto$LWS.define);
  CustomElementRegistryProto$LWS.whenDefined = getUnmaskedFunction$LWS(CustomElementRegistryProto$LWS.whenDefined);
}
// istanbul ignore next: dead code to be kept until 248
        ...
        if (unsanitizedValue$LWS !== null && unsanitizedValue$LWS !== undefined) {
          ...
          if (ReflectApply$LWS(StringProtoToLowerCase$LWS, command$LWS, []) === 'inserthtml') {
            ...
            if (type$LWS === 0 /* SandboxType.External */) {
              ...
              if (isSharedElement$m$LWS(activeElement$LWS) && ReflectApply$LWS(originalIsContentEditable$LWS, activeElement$LWS, [])) {
                throw new LockerSecurityError$LWS(`Cannot execute command '${command$LWS}' on ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, activeElement$LWS, [])}.`);
              }
            }
            // This must be called to signal to the virtual
  ...
  const distortionEntry$LWS = [originalAttachShadow$LWS, function attachShadow$LWS(...args$LWS) {
    ...
    if (args$LWS.length) {
      ...
      if (originalShadowRootInit$LWS !== null && originalShadowRootInit$LWS !== undefined) {
        ...
        ReflectSetPrototypeOf$LWS(shadowRootInit$LWS, originalShadowRootInitProto$LWS);
