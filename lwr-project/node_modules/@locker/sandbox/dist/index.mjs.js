...
function getDistortionFactories$LWS(record$LWS) {
  ...
  const initializers$LWS = type$LWS === 1 /* SandboxType.Internal */ ? ArrayConcat$LWS(internalDistortionFactoryInitializers$LWS, internalKeyedDistortionFactoryInitializers$LWS) : ArrayConcat$LWS(externalDistortionFactoryInitializers$LWS, externalKeyedDistortionFactoryInitializers$LWS);
...
SymbolFor$LWS('@@lockerNearMembraneSerializedValue');
SymbolFor$LWS('@@lockerNearMembrane');
SymbolFor$LWS('@@lockerLiveValue'); // Object brand constants.
...
function createMembraneMarshall$LWS(globalObject$LWS) {
  ...
  const ERR_ILLEGAL_PROPERTY_ACCESS$LWS = 'Illegal property access.'; // BigInt is not supported in Safari 13.1.
  // https://caniuse.com/bigint

  const FLAGS_REG_EXP$LWS = IS_IN_SHADOW_REALM$LWS ? /\w*$/ : undefined; // Minification safe references to the private `BoundaryProxyHandler`
    ...
    switch (brand$LWS) {
      ...
      case '[object Object]':
        try {
          ...
          return serializeSymbolObject$LWS(target$LWS); // eslint-disable-next-line no-empty
        } catch (_unused6$LWS) {}
        if (SUPPORTS_BIG_INT$LWS) {
          ...
          try {
            return serializeBigIntObject$LWS(target$LWS); // eslint-disable-next-line no-empty
          } catch (_unused7$LWS) {}
        }
  ...
  const serializeTargetByTrialAndError$LWS = IS_IN_SHADOW_REALM$LWS ? target$LWS => {
    ...
    try {
      return serializeBooleanObject$LWS(target$LWS); // eslint-disable-next-line no-empty
    } catch (_unused10$LWS) {}
    try {
      return serializeNumberObject$LWS(target$LWS); // eslint-disable-next-line no-empty
    } catch (_unused11$LWS) {}
    try {
      return serializeRegExp$LWS(target$LWS); // eslint-disable-next-line no-empty
    } catch (_unused12$LWS) {}
    try {
      return serializeStringObject$LWS(target$LWS); // eslint-disable-next-line no-empty
    } catch (_unused13$LWS) {}
    return undefined;
  } : noop$LWS;
  ...
  return function createHooksCallback$LWS(color$LWS, foreignCallableHooksCallback$LWS, options$LWS) {
    ...
    const {
      ...
      revokedProxyCallback: revokedProxyCallback$LWS // eslint-disable-next-line prefer-object-spread
    } = ObjectAssign$LWS({
      __proto__: null
    }, options$LWS);
    ...
    function createApplyOrConstructTrapForZeroOrMoreArgs$LWS(proxyTrapEnum$LWS) {
      ...
      return function applyOrConstructTrap$LWS(shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS) {
        ...
        if (length$LWS !== 0) {
          ...
          return this[(_arityToApplyOrConstr$LWS = arityToApplyOrConstructTrapNameRegistry$LWS[length$LWS]) != null ? _arityToApplyOrConstr$LWS : arityToApplyOrConstructTrapNameRegistry$LWS.n](shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS);
        }
        let activity$LWS;
        if (LOCKER_INSTRUMENTATION_FLAG$LWS) {
    ...
    function createApplyOrConstructTrapForOneOrMoreArgs$LWS(proxyTrapEnum$LWS) {
      ...
      return function applyOrConstructTrapForOneOrMoreArgs$LWS(shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS) {
        ...
        if (length$LWS !== 1) {
          ...
          return this[(_arityToApplyOrConstr2$LWS = arityToApplyOrConstructTrapNameRegistry$LWS[length$LWS]) != null ? _arityToApplyOrConstr2$LWS : arityToApplyOrConstructTrapNameRegistry$LWS.n](shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS);
        }
        let activity$LWS;
        if (LOCKER_INSTRUMENTATION_FLAG$LWS) {
          activity$LWS = startActivity$LWS(activityName$LWS);
    ...
    function createApplyOrConstructTrapForTwoOrMoreArgs$LWS(proxyTrapEnum$LWS) {
      ...
      return function applyOrConstructTrapForTwoOrMoreArgs$LWS(shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS) {
        ...
        if (length$LWS !== 2) {
          ...
          return this[(_arityToApplyOrConstr3$LWS = arityToApplyOrConstructTrapNameRegistry$LWS[length$LWS]) != null ? _arityToApplyOrConstr3$LWS : arityToApplyOrConstructTrapNameRegistry$LWS.n](shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS);
        }
        let activity$LWS;
        if (LOCKER_INSTRUMENTATION_FLAG$LWS) {
          activity$LWS = startActivity$LWS(activityName$LWS);
    ...
    function createApplyOrConstructTrapForThreeOrMoreArgs$LWS(proxyTrapEnum$LWS) {
      ...
      return function applyOrConstructTrapForTwoOrMoreArgs$LWS(shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS) {
        ...
        if (length$LWS !== 3) {
          ...
          return this[(_arityToApplyOrConstr4$LWS = arityToApplyOrConstructTrapNameRegistry$LWS[length$LWS]) != null ? _arityToApplyOrConstr4$LWS : arityToApplyOrConstructTrapNameRegistry$LWS.n](shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS);
        }
        let activity$LWS;
        if (LOCKER_INSTRUMENTATION_FLAG$LWS) {
          activity$LWS = startActivity$LWS(activityName$LWS);
    ...
    function createApplyOrConstructTrapForFourOrMoreArgs$LWS(proxyTrapEnum$LWS) {
      ...
      return function applyOrConstructTrapForTwoOrMoreArgs$LWS(shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS) {
        ...
        if (length$LWS !== 4) {
          ...
          return this[(_arityToApplyOrConstr5$LWS = arityToApplyOrConstructTrapNameRegistry$LWS[length$LWS]) != null ? _arityToApplyOrConstr5$LWS : arityToApplyOrConstructTrapNameRegistry$LWS.n](shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS);
        }
        let activity$LWS;
        if (LOCKER_INSTRUMENTATION_FLAG$LWS) {
          activity$LWS = startActivity$LWS(activityName$LWS);
    ...
    function createApplyOrConstructTrapForFiveOrMoreArgs$LWS(proxyTrapEnum$LWS) {
      ...
      return function applyOrConstructTrapForTwoOrMoreArgs$LWS(shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS) {
        ...
        if (length$LWS !== 5) {
          ...
          return this[(_arityToApplyOrConstr6$LWS = arityToApplyOrConstructTrapNameRegistry$LWS[length$LWS]) != null ? _arityToApplyOrConstr6$LWS : arityToApplyOrConstructTrapNameRegistry$LWS.n](shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS);
        }
        let activity$LWS;
        if (LOCKER_INSTRUMENTATION_FLAG$LWS) {
          activity$LWS = startActivity$LWS(activityName$LWS);
      ...
      return function applyOrConstructTrapForAnyNumberOfArgs$LWS(_shadowTarget$LWS, thisArgOrArgs$LWS, argsOrNewTarget$LWS) {
        ...
        try {
          ...
          for (let i$LWS = 0; i$LWS < length$LWS; i$LWS += 1) {
            const arg$LWS = args$LWS[i$LWS]; // Inlining `getTransferableValue()`.
    ...
    function getTransferablePointer$LWS(originalTarget$LWS, foreignCallablePusher$LWS = foreignCallablePushTarget$LWS) {
      ...
      if (typeof distortionTarget$LWS === 'function') {
        ...
        try {
          ...
          targetTraits$LWS |= 32
          /* TargetTraits.IsTypedArray */; // eslint-disable-next-line no-empty
        } catch (_unused17$LWS) {
    ...
    const installPropertyDescriptorMethodWrappers$LWS = IS_IN_SHADOW_REALM$LWS ? unforgeableGlobalThisKeys$LWS => {
      ...
      const getUnforgeableGlobalThisGetter$LWS = shouldFixChromeBug$LWS ? key$LWS => {
        ...
        if (globalThisGetter$LWS === undefined) {
          ...
          // eslint-disable-next-line @typescript-eslint/no-use-before-define
          unboundGlobalThisGetter$LWS, []); // Preserve identity continuity of getters.
        ...
        apply(_originalFunc$LWS, thisArg$LWS, args$LWS) {
          ...
          for (let i$LWS = 0, {
            ...
            if (isLazyProp$LWS || isFixingChromeBug$LWS) {
              const unsafeDesc$LWS = isFixingChromeBug$LWS ? getFixedDescriptor$LWS(target$LWS, ownKey$LWS) : ReflectGetOwnPropertyDescriptor$LWS(target$LWS, ownKey$LWS); // Update the descriptor map entry.
    ...
    function passthruForeignTraversedSet$LWS(foreignTargetPointer$LWS, shadowTarget$LWS, key$LWS, value$LWS, receiver$LWS) {
      const safeDesc$LWS = lookupForeignDescriptor$LWS(foreignTargetPointer$LWS, shadowTarget$LWS, key$LWS); // Following the specification steps for
    ...
    class BoundaryProxyHandler$LWS {
      ...
      static passthruIsExtensibleTrap(_shadowTarget$LWS) {
        ...
        let result$LWS = false; // Check if already locked.
      ...
      static passthruSetTrap(_shadowTarget$LWS, key$LWS, value$LWS, receiver$LWS) {
        ...
        try {
          ...
          // Inline getTransferableValue().
          typeof value$LWS === 'object' && value$LWS !== null || typeof value$LWS === 'function' ? getTransferablePointer$LWS(value$LWS) : value$LWS, LOCKER_NEAR_MEMBRANE_UNDEFINED_VALUE_SYMBOL$LWS) : passthruForeignTraversedSet$LWS(foreignTargetPointer$LWS, shadowTarget$LWS, key$LWS, value$LWS, receiver$LWS);
        } catch (error) {
    ...
    BoundaryProxyHandler$LWS.passthruHasTrap = IS_NOT_IN_SHADOW_REALM$LWS ? function (_shadowTarget$LWS, key$LWS) {
      ...
      const isNearMembraneSerializedValueSymbol$LWS = key$LWS === LOCKER_NEAR_MEMBRANE_SERIALIZED_VALUE_SYMBOL$LWS;
      if (result$LWS) {
        handshakePropertyFlag$LWS = false; // Checking the existence of forged handshake properties
        // is not allowed.
    ...
    (targetPointer$LWS, key$LWS) => {
      ...
      selectedTarget$LWS = undefined;
      const value$LWS = target$LWS == null ? void 0 : target$LWS[key$LWS]; // Intentionally ignoring `document.all`.
      // https://developer.mozilla.org/en-US/docs/Web/API/Document/all
      // https://tc39.es/ecma262/#sec-IsHTMLDDA-internal-slot
      ...
      /* TargetTraits.IsObject */) {
        try {
          if (!(key$LWS in target$LWS)) {
            ...
            const brand$LWS = ReflectApply$LWS(ObjectProtoToString$LWS, target$LWS, []); // The default language toStringTag is "Object". If
    ...
    // callableSet
    (targetPointer$LWS, key$LWS, valuePointerOrPrimitive$LWS, receiverPointerOrPrimitive$LWS) => {
      targetPointer$LWS();
      const target$LWS = selectedTarget$LWS;
      selectedTarget$LWS = undefined;
      let value$LWS;
    ...
    LOCKER_DEBUGGABLE_FLAG$LWS ? (...args$LWS) => {
      if (checkDebugMode$LWS()) {
        ...
        try {
          ReflectApply$LWS(consoleInfo$LWS, consoleObject$LWS, args$LWS); // eslint-disable-next-line no-empty
        } catch (_unused29$LWS) {}
      }
    } : noop$LWS,
    ...
    IS_NOT_IN_SHADOW_REALM$LWS && liveTargetCallback$LWS ? (targetPointer$LWS, targetTraits$LWS) => {
      ...
      if (target$LWS !== ObjectProto$LWS && target$LWS !== RegExpProto$LWS) {
        try {
          return liveTargetCallback$LWS(target$LWS, targetTraits$LWS); // eslint-disable-next-line no-empty
        } catch (_unused32$LWS) {}
      }
      return false;
    } : alwaysFalse$LWS,
    ...
    IS_IN_SHADOW_REALM$LWS ? targetPointer$LWS => {
      ...
      try {
        ...
        // Fast path.
        serializeTargetByBrand$LWS(target$LWS); // eslint-disable-next-line no-empty
      } catch (_unused34$LWS) {}
      return undefined;
    } : noop$LWS,
...
class VirtualEnvironment$LWS {
  constructor(options$LWS) {
    ...
    const {
      ...
      signSourceCallback: signSourceCallback$LWS // eslint-disable-next-line prefer-object-spread
    } = ObjectAssign$LWS({
      __proto__: null
    }, options$LWS);
    let blueHooks$LWS;
    ...
    this.blueCallableLinkPointers = blueCallableLinkPointers$LWS; // Ensure the `this` context of red callable functions is `undefined`.
  ...
  remapProperties(target$LWS, unsafeBlueDescs$LWS) {
    if (typeof target$LWS === 'object' && target$LWS !== null || typeof target$LWS === 'function') {
      ...
      for (let i$LWS = 0, j$LWS = 1; i$LWS < length$LWS; i$LWS += 1, j$LWS += 7) {
        const ownKey$LWS = ownKeys$LWS[i$LWS];
        const unsafeBlueDesc$LWS = unsafeBlueDescs$LWS[ownKey$LWS]; // Avoid poisoning by only installing own properties from unsafeBlueDescs.
...
function getGlobalObjectOwnKeys$LWS(source$LWS) {
  const ownKeys$LWS = ReflectOwnKeys$LWS(source$LWS); // WKWebView incorrectly excludes the 'webkit' own property of the global
...
function assignFilteredGlobalDescriptorsFromPropertyDescriptorMap$LWS(descs$LWS, source$LWS) {
  ...
  for (let i$LWS = 0, {
    ...
    const ownKey$LWS = ownKeys$LWS[i$LWS]; // Avoid overriding ECMAScript global names that correspond to
...
function getFilteredGlobalOwnKeys$LWS(source$LWS) {
  ...
  for (let i$LWS = 0, {
    ...
    const ownKey$LWS = ownKeys$LWS[i$LWS]; // Avoid overriding ECMAScript global names that correspond to global
...
function getCachedGlobalObjectReferences$LWS(globalObject$LWS) {
  ...
  let record$LWS;
  let document$LWS; // Suppress errors thrown on cross-origin opaque windows.

  try {
    ({
      document: document$LWS
    } = globalObject$LWS);
    record$LWS = blueDocumentToRecordMap$LWS.get(document$LWS); // eslint-disable-next-line no-empty
  } catch (_unused$LWS) {
    return undefined;
  }
  if (record$LWS) {
...
function removeWindowDescriptors$LWS(unsafeDescs$LWS) {
  ...
  ReflectDeleteProperty$LWS(unsafeDescs$LWS, 'window'); // Remove other browser specific unforgeables.
...
function createIframeVirtualEnvironment$LWS(globalObject$LWS, providedOptions$LWS) {
  ...
  linkIntrinsics$LWS(env$LWS, globalObject$LWS); // window
  // window.document
  ...
  if (keepAlive$LWS) {
    ...
    } = redWindow$LWS; // Revoke the proxies of the redDocument and redWindow to prevent access.
...
function createEvalHelpersFactoryArgs$LWS(record$LWS) {
  ...
  function loadScript$LWS(_thisArg$LWS, url$LWS) {
    ...
    for (let i$LWS = 0, {
      ...
      // istanbul ignore else: current tests have no way of expressing a state that would cause this condition to evaluate false
      if (ReflectApply$1$LWS(scriptSrcGetterDistortion$LWS, script$LWS, []) === resolvedURL$LWS) {
...
export { CORE_SANDBOX_KEY$LWS as CORE_SANDBOX_KEY, createRootWindowSandboxRecord$LWS as createRootWindowSandboxRecord, evaluateFunction$LWS as evaluateFunction, evaluateInCoreSandbox$LWS as evaluateInCoreSandbox, evaluateInSandbox$LWS as evaluateInSandbox, wrapDependency$LWS as wrapDependency };
/*! version: 0.19.15 */
