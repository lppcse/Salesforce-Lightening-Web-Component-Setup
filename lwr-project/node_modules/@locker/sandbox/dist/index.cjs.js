...
function getDistortionFactories$LWS(record$LWS) {
  ...
  const initializers$LWS = type$LWS === 1 /* SandboxType.Internal */ ? shared$LWS.ArrayConcat(distortion$LWS.internalDistortionFactoryInitializers, distortion$LWS.internalKeyedDistortionFactoryInitializers) : shared$LWS.ArrayConcat(distortion$LWS.externalDistortionFactoryInitializers, distortion$LWS.externalKeyedDistortionFactoryInitializers);
...
function createEvalHelpersFactoryArgs$LWS(record$LWS) {
  ...
  function loadScript$LWS(_thisArg$LWS, url$LWS) {
    ...
    for (let i$LWS = 0, {
      ...
      // istanbul ignore else: current tests have no way of expressing a state that would cause this condition to evaluate false
      if (shared$LWS.ReflectApply(scriptSrcGetterDistortion$LWS, script$LWS, []) === resolvedURL$LWS) {
