...
function getObservedAttributesList$LWS(baseDefinition$LWS, sourceDefinition$LWS) {
  ...
  return toSafeSet$LWS(new SetCtor$LWS$1([...sourceDefinition$LWS.observedAttributes].filter(
...
function patchAttributes$LWS(instance$LWS, originalDefinition$LWS, pivotDefinition$LWS) {
  ...
  observedAttributesList$LWS.forEach(originalAttributeName$LWS => {
    var _ref$LWS, _HTMLElementGlobalAtt$LWS;
    ...
    //
    const attributePropertyName$LWS = (_ref$LWS = (_HTMLElementGlobalAtt$LWS = HTMLElementGlobalAttributesToPropertyName$LWS[originalAttributeName$LWS]) != null ? _HTMLElementGlobalAtt$LWS : ElementAriaAttributesToPropertyName$LWS[originalAttributeName$LWS]) != null ? _ref$LWS : originalAttributeName$LWS;
    if (attributePropertyName$LWS in instance$LWS) {
      const descriptor$LWS = {
        ...
        get() {
          ...
          return ReflectGet$LWS(this.__proto__, attributePropertyName$LWS, this);
        },
        set(value$LWS) {
          ...
          const oldValue$LWS = ReflectApply$LWS$1(ElementProtoGetAttribute$LWS, this, [originalAttributeName$LWS]);
          ...
          // @ts-ignore this.__proto__
          // eslint-disable-next-line no-proto
          ReflectSet$LWS(this.__proto__, attributePropertyName$LWS, value$LWS, this);
          const newValue$LWS = ReflectApply$LWS$1(ElementProtoGetAttribute$LWS, this, [originalAttributeName$LWS]);
          if (oldValue$LWS !== newValue$LWS) {
            ReflectApply$LWS$1(attributeChangedCallback$LWS, this, [originalAttributeName$LWS, oldValue$LWS, newValue$LWS]);
          }
        }
      };
      ReflectDefineProperty$LWS$1(instance$LWS, attributePropertyName$LWS, descriptor$LWS);
    }
  });
}
...
function createEvalHelpersFactoryArgs$LWS(record$LWS) {
  ...
  function loadScript$LWS(_thisArg$LWS, url$LWS) {
    ...
    for (let i$LWS = 0, {
      ...
      // istanbul ignore else: current tests have no way of expressing a state that would cause this condition to evaluate false
      if (ReflectApply$LWS$1(scriptSrcGetterDistortion$LWS, script$LWS, []) === resolvedURL$LWS) {
