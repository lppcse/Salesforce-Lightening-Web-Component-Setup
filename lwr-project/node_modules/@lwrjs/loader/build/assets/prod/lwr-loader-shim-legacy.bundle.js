...
(function () {
  ...
  class LoaderShim {
      ...
      constructor(global) {LoaderShim.prototype.__init.call(this);LoaderShim.prototype.__init2.call(this);
          ...
          this.loaderModule = 'lwr/loaderLegacy/v/0_10_6';
      ...
      // Note: The profiler is also available as a module through lwc module resolution (see package.json)
       createProfilerModule(globalLWR) {
          ...
          globalLWR.define('lwr/profiler/v/0_10_6', ['exports'], exporter, {});
      }
  ...
  if (GLOBAL.LWR.requiredModules.indexOf('lwr/loaderLegacy/v/0_10_6') < 0) {
      GLOBAL.LWR.requiredModules.push('lwr/loaderLegacy/v/0_10_6');
  }
...
LWR.define('lwr/loaderLegacy/v/0_10_6', ['exports'], (function (exports) { 'use strict';
